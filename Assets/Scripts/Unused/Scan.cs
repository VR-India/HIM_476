...
public class Scan : MonoBehaviour
{
    ...
    private void Update()
    {
        if (snapZone[0].HeldItem != null && snapZone[1].HeldItem != null && PatientInteractionAnimator.instance.scannerGhost.active)
        {
            PatientInteractionAnimator.instance.scannerGhost.GetComponent<Animator>().Play("scannerBtnPress");
        }
    }
